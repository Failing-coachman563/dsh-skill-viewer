...
/**
 * dsh-webui-skills-viewer - host half.
 *
...
const MANIFEST = {
  package: "dsh-webui-skills-viewer",
  face: "host",
  schemas: [],
  invocations: [
    {
      id: "dsh-webui-skills-viewer#skillsViewer/list",
      service: "skillsViewer",
      namespace: "skillsViewer",
      method: "list",
      invocation: { kind: "direct" },
      parameters: [
        { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dsh-webui-skills-viewer#sessionId", schema: sessionIdSchema } }
      ],
      result: { mode: "strict", typeSymbol: "dsh-webui-skills-viewer#SkillListResult", schema: listResultSchema }
    },
    {
      id: "dsh-webui-skills-viewer#skillsViewer/content",
      service: "skillsViewer",
      namespace: "skillsViewer",
      method: "content",
      invocation: { kind: "direct" },
      parameters: [
        { name: "name", wire: "name", source: "json", codec: { mode: "strict", typeSymbol: "dsh-webui-skills-viewer#SkillName", schema: z.string() } },
        { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dsh-webui-skills-viewer#sessionId", schema: sessionIdSchema } }
      ],
      result: { mode: "strict", typeSymbol: "dsh-webui-skills-viewer#SkillContent", schema: skillContentSchema }
    },
    {
      id: "dsh-webui-skills-viewer#skillsViewer/setEnabled",
      service: "skillsViewer",
      namespace: "skillsViewer",
      method: "setEnabled",
      invocation: { kind: "direct" },
      parameters: [
        { name: "name", wire: "name", source: "json", codec: { mode: "strict", typeSymbol: "dsh-webui-skills-viewer#SkillName", schema: z.string() } },
        { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dsh-webui-skills-viewer#sessionId", schema: sessionIdSchema } },
        { name: "enabled", wire: "enabled", source: "json", codec: { mode: "strict", typeSymbol: "dsh-webui-skills-viewer#EnabledFlag", schema: z.boolean() } }
      ],
      result: { mode: "strict", typeSymbol: "dsh-webui-skills-viewer#SetEnabledResult", schema: setEnabledResultSchema }
    },
    {
      id: "dsh-webui-skills-viewer#skillsViewer/deleteSkill",
      service: "skillsViewer",
      namespace: "skillsViewer",
      method: "deleteSkill",
      invocation: { kind: "direct" },
      ...
      result: { mode: "strict", typeSymbol: "dsh-webui-skills-viewer#DeleteSkillResult", schema: deleteSkillResultSchema }
    },
    {
      id: "dsh-webui-skills-viewer#skillsViewer/addSkill",
      service: "skillsViewer",
      namespace: "skillsViewer",
      method: "addSkill",
      invocation: { kind: "direct" },
      parameters: [
        { name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: { mode: "strict", typeSymbol: "dsh-webui-skills-viewer#sessionId", schema: sessionIdSchema } },
        { name: "payload", wire: "payload", source: "json", codec: { mode: "strict", typeSymbol: "dsh-webui-skills-viewer#AddPayload", schema: addPayloadSchema } }
      ],
      result: { mode: "strict", typeSymbol: "dsh-webui-skills-viewer#AddResult", schema: addResultSchema }
    }
  ],
...
class SkillsViewerGateway extends TypertRemoteService {
  ...
  async addSkill(sessionId, payload) {
    ...
    if (kind === "bundle") {
      ...
      if (!file.path.endsWith(".md") || file.path.includes("/")) throw new Error("技能文件必须是 .md 文件");
      const validation = validateFrontmatter(file.data.toString("utf8"));
      if (!validation.ok) throw new Error("技能格式不符合要求：" + validation.error);
      name = validation.skill.name;
      writes = [{ relative: file.path, data: file.data }];
    }
