...
const css = cssChrome + cssCards + cssAdd + cssScope + cssMigrate + cssUtils + cssIcon;
		...
		const zh = {
			...
			migratePickTarget: "请选择目标作用域",
			migrateSameScope: "源作用域与目标作用域不能相同",
		...
		const en = {
			...
			migratePickTarget: "Pick a target scope",
			migrateSameScope: "Source and target scopes must differ",
...
// ── 批量迁移对话框 ─────────────────────────────────────────────────────
		function MigrateDialog({ t, options, from, target, setTarget, mode, setMode, skills, selected, toggle, selectAll, busy, result, error, onConfirm, onCancel, onClose }) {
			...
			const fromLabel = from === "global" ? t("scopeGlobal") : from;
			...
			return (0, react_jsx_runtime.jsx)("div", {
				...
				children: (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsx)("h4", { children: t("migrateTitle") }), (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsx)("p", { className: c.migrateLabel, children: t("migrateFrom") }), (0, react_jsx_runtime.jsx)("p", {
							className: c.migrateFromValue,
							title: from,
							children: fromLabel
						})]
						...
						children: [(0, react_jsx_runtime.jsx)("p", { className: c.migrateLabel, children: t("migrateTo") }), (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsxs)("button", {
								...
								"data-active": target === "global" ? "true" : void 0,
								onClick: () => {
									pickTarget("global");
								},
								...
								type: "button",
								className: c.scopeOption,
								"data-active": target === option.path ? "true" : void 0,
								onClick: () => {
									pickTarget(option.path);
								},
								children: [(0, react_jsx_runtime.jsx)("input", {
									type: "radio",
									name: "migrate-target",
									checked: target === option.path,
									readOnly: true
						...
						children: [(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsx)("p", { className: c.migrateLabel, children: fromLabel + " · " + skills.length }), (0, react_jsx_runtime.jsx)("button", {
								type: "button",
						...
						children: result === null ? [(0, react_jsx_runtime.jsx)("button", {
							...
							disabled: busy || target === "" || selected.size === 0 || from === target,
							onClick: onConfirm,
...
function SkillsSection(props) {
			...
			// 批量迁移：打开对话框并预载源作用域的技能。
			const openMigrator = () => {
				const known = Array.isArray(wsOptions) ? wsOptions : [];
				const from = scopeFilter;
				const source = skills.filter((skill) => scopeOf(skill) === from);
				const defaultTarget = from === "global" ? (known.length > 0 ? known[0].path : "") : "global";
				setMigrator({
					from,
					target: defaultTarget,
					mode: "move",
					selected: new Set(source.map((skill) => skill.name)),
					busy: false,
					result: null,
					error: null
				});
			...
			const applyBatchMigrate = () => {
				...
				const payload = {
					...
					target: m.target === "global" ? null : m.target,
					mode: m.mode,
					names: [...m.selected]
				};
...
const onPickFolder = (event) => {
			...
			const scopeInfo = (skill) => {
				...
				if (scope === undefined || scope === null || scope.kind === "global") return { text: t("scopeGlobal"), scoped: false, zero: false, title: t("scopeGlobal") };
				return { text: scope.label !== undefined && scope.label !== "" ? scope.label : labelOf(scope.path), scoped: true, zero: false, title: scope.path };
			};
				...
				children: listState.status === "loading" ? (0, react_jsx_runtime.jsx)("p", {
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: scopeKeys.map((key) => (0, react_jsx_runtime.jsxs)("button", {
							...
							children: [key === "global" ? t("scopeGlobal") : labelOf(key), (0, react_jsx_runtime.jsx)("span", {
...
migrator !== null ? (0, react_jsx_runtime.jsx)(MigrateDialog, {
						...
						setTarget: (value) => {
							setMigrator((prev) => (prev === null ? prev : { ...prev, target: value, error: null }));
						},
						mode: migrator.mode,
						setMode: (value) => {
						...
						selectAll: () => {
							setMigrator((prev) => {
								if (prev === null) return prev;
								const all = new Set(scoped.map((skill) => skill.name));
