window.__ModuleLoader__.load({
	id: "dsh-webui-skills-viewer",
	factory: (require) => {
		var module = { exports: {} };
		var exports = module.exports;
		Object.defineProperty(exports, Symbol.toStringTag, { value: "Module" });
		// Bundle contract: this file is served by the host at
		// /plugins/dsh-webui-skills-viewer/client.js and must only require
		...
		const tagId = "dsh-webui-skills-viewer/SkillsSection.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-webui-skills-viewer";
			...
			descriptors: [
				{
					...
					parameters: [
						{ name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: codec("dsh-webui-skills-viewer#sessionId") }
					],
					result: codec("dsh-webui-skills-viewer#SkillListResult")
				},
				{
					...
					invocation: { kind: "direct" },
					parameters: [
						{ name: "name", wire: "name", source: "json", codec: codec("dsh-webui-skills-viewer#SkillName") },
						{ name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: codec("dsh-webui-skills-viewer#sessionId") }
					],
					result: codec("dsh-webui-skills-viewer#SkillContent")
				},
				{
					...
					parameters: [
						{ name: "name", wire: "name", source: "json", codec: codec("dsh-webui-skills-viewer#SkillName") },
						{ name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: codec("dsh-webui-skills-viewer#sessionId") },
						{ name: "enabled", wire: "enabled", source: "json", codec: codec("dsh-webui-skills-viewer#EnabledFlag") }
					],
					result: codec("dsh-webui-skills-viewer#SetEnabledResult")
				},
				{
					...
					result: codec("dsh-webui-skills-viewer#DeleteSkillResult")
				},
				{
					...
					parameters: [
						{ name: "sessionId", wire: "sessionId", source: "json", acceptsUndefined: true, codec: codec("dsh-webui-skills-viewer#sessionId") },
						{ name: "payload", wire: "payload", source: "json", codec: codec("dsh-webui-skills-viewer#AddPayload") }
					],
					result: codec("dsh-webui-skills-viewer#AddResult")
				}
			]
		};
		...
		function SkillsSection(props) {
			...
			const runAdd = (kind, files) => {
				...
				Promise.all(files.map(readFileAsBase64)).then((items) => {
					const payloadFiles = items.map((base64, index) => ({ path: files[index].webkitRelativePath.replaceAll("\\", "/"), base64 }));
